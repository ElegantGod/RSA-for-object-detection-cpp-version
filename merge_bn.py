...
train_proto = 'sfn_lrn_bn.prototxt'  
train_model = 'tot_wometa_1epoch'  #should be your snapshot caffemodel

deploy_proto = 'sfn_lrn.prototxt'  
save_model = 'sfn_lrn.caffemodel'
...
def merge_bn(net, nob):
    ...
    for layer_name, layer_type, layer_blobs in layer_iter:
        ...
        if layer_type == 'Input' or layer_type == 'ReLU' or layer_type == 'Pooling' or layer_type == 'Split' or layer_type == 'Eltwise':
            continue
